...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
SCREEN_TITLE = "Baldies Static Sprite"
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.total_time = 0.0
        self.font_color = arcade.color.BATTLESHIP_GREY
    ...
    def on_draw(self):
        ...
        # Added static sprite
        texture = arcade.load_texture("baldies_loading.png")
        arcade.draw_texture_rectangle(400, 300, 1.2 * texture.width,
                                      1.2 * texture.height, texture, 0)
